      ...
      <div class="page-header">
        <div class="page-block">
          <div class="page-header-title">
            <h5 class="mb-0 font-medium">ALL APPOINTMENT</h5>
          </div>
          <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="../admin/dashboard.php">Home</a></li>
            <li class="breadcrumb-item" aria-current="page">ALL APPOINTMENT</li>
          </ul>
        </div>
      </div>
      <!-- [ breadcrumb ] end -->
        ...
        <div class="col-span-12">
          <div class="card">
            <div class="card-header">
              <h5>Salon Clients <span style="color: red; font-weight: bold;"></span></h5>
            </div>
            <div class="card-body">
               <table>
                  <thead>
                  ...
                  <tbody>
                    ...
                    try {
                      $stmt = $pdo->query("SELECT * FROM accepted_appointment_view");
