...
<button class="back-to-top" onclick="window.scrollTo({top: 0, behavior: 'smooth'});">↑</button>
 ...
 <main class="contact_main">
 	...
 	<h3 class="text3">Get in Touch</h3>
 	
 	<p class="text4">We’d love to hear from you! Whether you’re booking an<br> appointment, asking about our services, or just want to say hi,<br> feel free to reach out to us.
	.</p>

<h3 class="text5">Address</h3>
<p class="text6">183 Purok 2 Lucao District, Dagupan City Pangasinan</p>

<h3 class="text7">Opening Hour</h3>
<p class="text8">8:00 AM – 6:00 PM<br> Monday - Saturday</p>

<h3 class="text9">Contacts</h3>
<p class="text10">Call: +63 945 250 8060<br> E-mail: beautyblossom@gmail.com</p>

<img src="../assets/images/map.jpg" class="map">
 </main>
